...
#### deepl免秘钥bob插件下载地址:[DeepL翻译插件(免秘钥,免启动服务)](https://github.com/akl7777777/bob-plugin-akl-deepl-free-translate/releases/download/v0.2.5/bob-plugin-akl-deepl-free-translate_v0.2.5.bobplugin)

使用方法:双击安装,直接使用

### ChatGPT免费桌面版客户端(支持Windows,macOS)
下载地址:[OpenAI-ChatGPT](https://github.com/akl7777777/free-chatgpt-client-pub)
